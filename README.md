...
[Project X](https://github.com/XTLS) originates from XTLS protocol, providing a set of network tools such as [Xray-core](https://xray-core) and [REALITY](https://github.com/XTLS/REALITY).

[README](https://xray-core#readme) is open, so feel free to submit your project [here](https://xray-core/pulls).

## License

[Mozilla Public License Version 2.0](https://xray-core/blob/main/LICENSE)
...
[Code of Conduct](https://xray-core/blob/main/CODE_OF_CONDUCT.md)

## Credits

- [Xray-core v1.0.0](https://xray-core/releases/tag/v1.0.0) was forked from [v2fly-core 9a03cc5](https://github.com/v2fly/v2ray-core/commit/9a03cc5c98d04cc28320fcee26dbc236b3291256), and we have made & accumulated a huge number of enhancements over time, check [the release notes for each version](https://xray-core/releases).
- For third-party projects used in [Xray-core](https://xray-core), check your local or [the latest go.mod](https://xray-core/blob/main/go.mod).
